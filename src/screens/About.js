...
const About = () => (
	<React.Fragment>
		...
		<div className="content about">
			...
			<h2>Open Source</h2>
			<p>I built <strong>OneTwoThreeHappy</strong> as a learning excercise. I wanted to learn React and this seemed like a relatively simple project to use as my first. As such, I thought I would build it in the open.</p>
